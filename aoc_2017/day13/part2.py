...
def can_pass_trough(firewall_state: list[tuple[int, t.Literal[1, -1]] | None]) -> bool:
    packet_layer = -1
...
while True:
    ...
    if can_pass_trough(firewall_state.copy()):
        break

    delay += 1

# Note: Very not optimized, maybe a recursive function could do it better?

print(f"Result: {delay}")
